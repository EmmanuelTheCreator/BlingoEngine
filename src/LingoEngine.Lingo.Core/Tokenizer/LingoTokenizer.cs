    ...
    public class LingoTokenizer
    {
        ...
        private static readonly Dictionary<string, LingoTokenType> _keywords = new(StringComparer.OrdinalIgnoreCase)
            {
                ...
                { "instance", LingoTokenType.Instance },
        ...
        public LingoToken NextToken()
        {
            ...
            return c switch
            {
                ...
                '[' => MakeToken(LingoTokenType.LeftBracket),
                ']' => MakeToken(LingoTokenType.RightBracket),
                ',' => MakeToken(LingoTokenType.Comma),
                '.' => Match('.') ? MakeToken(LingoTokenType.Range) : MakeToken(LingoTokenType.Dot),
