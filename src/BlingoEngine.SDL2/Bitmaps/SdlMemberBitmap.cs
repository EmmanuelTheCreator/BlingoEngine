...
namespace BlingoEngine.SDL2.Bitmaps;
public class SdlMemberBitmap : IBlingoFrameworkMemberBitmap, IDisposable
{
    ...
    private readonly Dictionary<BlingoInkType, SdlTexture2D> _inkTextures = new();
    ...
    public void Preload()
    {
        ...
        //var surfaceBlingo = new SdlImageTexture(_surfacePtr, _surface, Width, Height);
    ...
    public IAbstTexture2D? GetTextureForInk(BlingoInkType ink, AColor backColor, nint renderer)
    {
