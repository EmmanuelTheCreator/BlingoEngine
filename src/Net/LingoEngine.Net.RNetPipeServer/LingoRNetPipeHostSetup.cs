...
/// </summary>
public static class LingoRNetPipeHostSetup
{
    /// <summary>
    ...
    public static ILingoEngineRegistration WithRNetPipeHostServer(this ILingoEngineRegistration reg, int port = 61699, bool autoStart = false)
    {
