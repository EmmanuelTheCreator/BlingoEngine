...
namespace BlingoEngine.Net.RNetTerminal.Dialogs
{
    ...
    {
        public static void EditSpriteDialog(string title, Blingo2DSpriteDTO? sprite,Action<(int Begin, int End, int LocH, int LocV, int CastLibNum, int NumberInCast, float Width, float Height)> onOk)
        {
            var colX1 = 1;
            var colX2 = 14;
            var colX3 = 22;
