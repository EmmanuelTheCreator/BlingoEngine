...
namespace BlingoEngine.Net.RNetClient.Common;

/// <summary>
/// Shared contract implemented by RNet clients regardless of transport.
/// </summary>
public interface IBlingoRNetClient : IAsyncDisposable
{
    ...
    Task<BlingoProjectJsonDto> GetCurrentProjectAsync(CancellationToken ct = default);
