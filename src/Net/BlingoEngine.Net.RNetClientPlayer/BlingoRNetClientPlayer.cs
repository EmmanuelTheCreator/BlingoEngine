...
/// </summary>
public sealed class BlingoRNetClientPlayer : IAsyncDisposable
{
    private readonly IBlingoRNetProjectClient _client;
    private readonly RNetClientPlayerApplier _applier;
    private CancellationTokenSource? _cts;
    private Task? _pumpTask;

    public BlingoRNetClientPlayer(IBlingoRNetProjectClient client, IBlingoPlayer player)
    {
        _client = client;
