...
public static class RNetPropertySetter
{
    ...
    private static void TrySetSprite(LingoSprite2D sprite, string prop, string value)
    {
        switch (prop)
        {
            ...
            case nameof(LingoSprite2D.LocV):
                ...
                break;
            case nameof(LingoSprite2D.LocZ):
    ...
    private static void TrySetMember(ILingoMember member, string prop, string value)
    {
        switch (member)
        {
    ...
    private static void TrySetTextMember(ILingoMemberTextBase text, string prop, string value)
    {
        switch (prop)
        {
            case "MarkDownText":
    ...
    private static void TrySetSoundMember(LingoMemberSound sound, string prop, string value)
    {
        switch (prop)
        {
            case nameof(LingoMemberSound.Loop):
                if (TryConvert(typeof(bool), value, out var loop)) sound.Loop = (bool)loop!;
                break;
            case nameof(LingoMemberSound.IsLinked):
                if (TryConvert(typeof(bool), value, out var linked)) sound.IsLinked = (bool)linked!;
                break;
            case nameof(LingoMemberSound.LinkedFilePath):
