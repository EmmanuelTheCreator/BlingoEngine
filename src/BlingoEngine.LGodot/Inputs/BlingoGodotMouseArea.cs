...
namespace BlingoEngine.LGodot
{
    ...
    public partial class BlingoGodotMouseArea : Area2D, IAbstFrameworkMouse, IBlingoFrameworkMouse
    {
        private readonly BlingoGodotMouse _handler;
        private CollisionShape2D _collisionShape2D = new();
        private RectangleShape2D _RectangleShape2D = new();
        private int _offsetX;
        private int _offsetY;

        public BlingoGodotMouseArea(Node rootNode, Lazy<IAbstMouseInternal> blingoMouse)
        {
            Name = "MouseConnector";
            _handler = new BlingoGodotMouse(blingoMouse);
        ...
        public void ReplaceMouseObj(IAbstMouse blingoMouse) => _handler.ReplaceMouseObj(blingoMouse);
        public void Release()
        {
        ...
        public void SetCursor(BlingoMemberBitmap? image) => _handler.SetCursor(image);
