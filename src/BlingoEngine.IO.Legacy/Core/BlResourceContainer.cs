...
public static class BlResourceContainerExtensions
{
    /// <summary>
    /// Registers a resource entry decoded from the current map.
    /// </summary>
    /// <param name="entry">Resource metadata parsed from the archive.</param>
    public static void AddResource(this ReaderContext context, BlLegacyResourceEntry entry)
    {
    ...
    public static void SetResourceInlineSegment(this ReaderContext context, int resourceId, byte[] data)
    {
        ArgumentNullException.ThrowIfNull(data);
        context.Resources.SetInlineSegment(resourceId, data);
    }
    ...
    public static void AddResourceRelationship(this ReaderContext context, BlResourceKeyLink link)
    {
