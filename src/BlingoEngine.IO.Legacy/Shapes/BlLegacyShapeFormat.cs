...
internal enum BlLegacyShapeFormatKind
{
    ...
    /// must be normalised back into the 0–255 range. See src/BlingoEngine.IO.Legacy/docs/LegacyShapeRecords.md.
    /// </summary>
    ...
    /// src/BlingoEngine.IO.Legacy/docs/LegacyShapeRecords.md.
    /// </summary>
