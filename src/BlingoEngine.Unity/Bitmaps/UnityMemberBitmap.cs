...
namespace BlingoEngine.Unity.Bitmaps;

public class UnityMemberBitmap : IBlingoFrameworkMemberBitmap, IDisposable
{
    private BlingoMemberBitmap _member = null!;
    private Texture2D? _texture;
    private UnityTexture2D? _textureWrapper;
    private readonly Dictionary<BlingoInkType, UnityTexture2D> _inkCache = new();
    ...
    private IAbstTexture2D? GetTextureForInk(BlingoInkType ink, AColor backColor)
    {
        if (_texture == null)
            return null;
