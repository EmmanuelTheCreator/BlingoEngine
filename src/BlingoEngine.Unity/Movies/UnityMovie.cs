...
using BlingoEngine.Unity.Sprites;
using AbstUI.Primitives;
using AbstUI.Components;

namespace BlingoEngine.Unity.Movies;

/// <summary>
/// Basic Unity movie container. Responsible for holding sprites and
/// forwarding updates to them.
/// </summary>
public class UnityMovie : IBlingoFrameworkMovie, IDisposable
{
    private readonly UnityStage _stage;
    private readonly Action<UnityMovie> _remove;
    private readonly HashSet<BlingoUnitySprite2D> _drawnSprites = new();
    private readonly HashSet<BlingoUnitySprite2D> _allSprites = new();
    ...
    public UnityMovie(UnityStage stage, BlingoMovie movie, Action<UnityMovie> remove)
    {
        _stage = stage;
        _remove = remove;
    ...
    {
        var sprite = new BlingoUnitySprite2D(blingoSprite, _root.transform,
