...
/// </summary>
public abstract class UnityMemberTextBase<TText> : IBlingoFrameworkMemberTextBase, IDisposable where TText : IBlingoMemberTextBase
{
    ...
    public IAbstTexture2D? TextureBlingo => _textureWrapper;
    ...
    public void PasteClipboardInto() => _blingoMemberText.Text = PasteClipboard();
    public void Preload()
    {
        if (_isLoaded)
            return;
    ...
    public IAbstTexture2D? RenderToTexture(BlingoInkType ink, AColor transparentColor)
    {
        ...
        Width = width;
        Height = height;
        _blingoMemberText.Width = width;
        _blingoMemberText.Height = height;
        //_blingoMemberText.RegPoint = new APoint(0, -height / 2);
