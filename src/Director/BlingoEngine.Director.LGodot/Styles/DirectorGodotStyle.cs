...
namespace BlingoEngine.Director.LGodot.Styles;
...
{
    private readonly BlingoGodotStyle blingoGodotStyle;
    ...
    public DirectorGodotStyle(BlingoGodotStyle blingoGodotStyle)
    {
        this.blingoGodotStyle = blingoGodotStyle;
        Theme = BuildTheme();
    }
    public static Font DefaultFont => GD.Load<Font>("res://Media/Fonts/ARIAL.TTF");
    private Theme BuildTheme()
    {
        var theme = blingoGodotStyle.Theme;
