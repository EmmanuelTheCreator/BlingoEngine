...
public class PaintToolbar : DirectorToolbar<PainterToolType>
{
    ...
    public PaintToolbar(IDirectorIconManager iconManager, IAbstCommandManager commandManager, IBlingoFrameworkFactory factory) : base("PaintToolbarRoot", iconManager, commandManager, factory)
    {
