...
namespace BlingoEngine.Director.Core.Styles
{
    public class DirectorColors
    {
        ...
        // Code Highlighting
        public static AColor BlingoCodeKeyword = new AColor(0, 0, 200); // Blue
        public static AColor BlingoCodeLiteral = new AColor(80, 80, 80); // Dark gray
        public static AColor BlingoCodeComment = new AColor(200, 0, 0); // Dark red
        public static AColor BlingoCodeBuiltIn = new AColor(0, 128, 0); // Green
