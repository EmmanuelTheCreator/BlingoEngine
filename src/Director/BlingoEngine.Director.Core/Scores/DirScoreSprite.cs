...
#pragma warning restore CS8618 
    ...
    public class DirScoreSprite : IDisposable
    {
        ...
        public BlingoSprite Sprite { get; }
        public BlingoSprite2D? Sprite2D { get; }
        ...
        public DirScoreSprite(BlingoSprite sprite, IDirSpritesManager spritesManager)
        {
            Sprite = sprite;
            _spritesManager = spritesManager;
            Sprite2D = sprite as BlingoSprite2D;
            Sprite.AnimationChanged += OnAnimationChanged;
            _spritesManager.SpritesSelection.SelectionCleared += OnSelectionCleared;
            spritesManager.Mediator.Subscribe<BlingoSprite>(DirectorEventType.SpriteSelected, s =>
            {
                if (s == Sprite)
                    IsSelected = true;
                return true;
