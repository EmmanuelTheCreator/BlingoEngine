...
#pragma warning restore CS8618 
        ...
        public abstract DirScoreSprite? FindSprite(BlingoSprite sprite);
        public abstract DirScoreSprite? GetSpriteAtFrame(int frame);
        public abstract IEnumerable<DirScoreSprite> GetSprites();
        protected virtual void SubscribeMovie(BlingoMovie movie) { }
        protected virtual void UnsubscribeMovie(BlingoMovie movie) { }
        ...
        internal virtual void ShowCreateSpriteDialog(int frameNumber, Action<BlingoSprite?> newSprite)
        {
        }
        internal virtual void ShowSpriteDialog(BlingoSprite sprite)
        {
        }
    ...
    internal abstract partial class DirScoreChannel<TSpriteManager, TSpriteUI, TSprite> : DirScoreChannel, IDirScoreChannel
        ...
        where TSpriteManager : IBlingoSpriteManager<TSprite>
        where TSprite : BlingoSprite
    {
        ...
        protected override void SubscribeMovie(BlingoMovie movie)
        {
        ...
        protected override void UnsubscribeMovie(BlingoMovie movie)
        {
            if (_manager == null) return;
            if (_subscribeToSpritelistChange) _manager.SpriteListChanged -= SpriteListChanged;
        }
        ...
        public override DirScoreSprite? FindSprite(BlingoSprite sprite)
            => _spriteUIs.FirstOrDefault(s => s.Sprite == sprite);
        protected abstract TSpriteManager GetManager(BlingoMovie movie);
