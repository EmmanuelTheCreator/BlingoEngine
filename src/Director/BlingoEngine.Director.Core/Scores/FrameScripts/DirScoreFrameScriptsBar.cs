...
internal partial class DirGodotFrameScriptsBar : Control
{
    ...
    private BlingoSprite2D? _dragSprite;
    private int _dragFrame;

    public DirGodotFrameScriptsBar(DirScoreGfxValues gfxValues, IBlingoFrameworkFactory factory)
    {
        ...
        _gridViewport.AddChild(_gridCanvas.Canvas.Framework<BlingoGodotGfxCanvas>());
