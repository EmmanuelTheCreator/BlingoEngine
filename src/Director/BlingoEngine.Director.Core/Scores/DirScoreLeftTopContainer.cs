...
namespace BlingoEngine.Director.Core.Scores
{
    public class DirScoreLeftTopContainer : DirScoreLeftContainer
    {
        ...
        public DirScoreLeftTopContainer(DirScoreGfxValues gfxValues, IBlingoFrameworkFactory factory, APoint position, IDirectorEventMediator mediator) : base(gfxValues, factory, position,6, mediator)
        {
