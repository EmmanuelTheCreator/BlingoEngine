...
public class DirectorBinaryViewerWindowV2 : DirectorWindow<IDirFrameworkBinaryViewerWindowV2>
{
    ...
    public DirectorBinaryViewerWindowV2(IServiceProvider serviceProvider, ILogger<DirectorBinaryViewerWindowV2> logger, IBlingoFrameworkFactory factory) : base(serviceProvider, DirectorMenuCodes.BinaryViewerWindowV2)
    {
        _logger = logger;
        Width = 1400;
        Height = 600;
    ...
    private void LoadTestData()
    {
        try
        {
            string path = Path.Combine(
                "..", "..", "Libraries", "BlingoEngine", "WillMoveToOwnRepo", "ProjectorRays", "Test", "TestData",
                "KeyFramesTest.dir"
                );
