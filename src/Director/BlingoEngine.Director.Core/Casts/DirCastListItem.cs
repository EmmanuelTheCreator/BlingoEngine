...
namespace BlingoEngine.Director.Core.Casts
{
    ...
    public class DirCastListItem : IDirCastItem, IDisposable
    {
        ...
        public DirCastListItem(IBlingoFrameworkFactory factory, IBlingoMember member, IDirectorIconManager iconManager)
        {
        ...
        private void DrawRow()
        {
            ...
            _panel.DrawText(new APoint(190, vPosText), member is BlingoEngine.Scripts.BlingoMemberScript script ? script.ScriptType.ToString() : "", null, textColor, 10, 280);
        ...
        public void SetMember(IBlingoMember member)
        {
           ...
           var iconType = BlingoMemberTypeIcons.GetIconType(member);
