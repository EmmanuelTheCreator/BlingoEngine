...
namespace LingoEngine.Director.Core.UI
{
    ...
    {
        public static AbstUIGfxCanvas DrawHLine(this AbstUIGfxCanvas canvas, float x, float y, float width)
        {
        ...
        public static AbstUIGfxCanvas DrawHLineR(this AbstUIGfxCanvas canvas, float x, float y, float width)
        {
        ...
        public static AbstUIGfxCanvas DrawVLine(this AbstUIGfxCanvas canvas,  float x, float y, float height)
        {
        ...
        public static AbstUIGfxCanvas DrawVLineR(this AbstUIGfxCanvas canvas,  float x, float y, float height)
        {
