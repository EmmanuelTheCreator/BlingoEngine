...
//    {
//        IAbstWindowManager Register<TWindow>(string windowCode, Func<IServiceProvider, IDirectorWindow> constructor, DirectorShortCutMap? shortCutMap = null)
//             where TWindow : IDirectorWindow;
//        IAbstWindowManager Register<TWindow>(string windowCode, DirectorShortCutMap? shortCutMap = null)
//             where TWindow : IDirectorWindow;
...
//    }
//    public class DirectorWindowManager : IAbstWindowManager,
...
//        private IAbstFrameworkWindowManager _frameworkWindowManager;
...
//        public IAbstWindowManager Register<TWindow>(string windowCode, Func<IServiceProvider, IDirectorWindow> constructor, DirectorShortCutMap? shortCutMap = null)
//            where TWindow : IDirectorWindow
//        {
...
//        public IAbstWindowManager Register<TWindow>(string windowCode, DirectorShortCutMap? shortCutMap = null)
//            where TWindow : IDirectorWindow
//        {
//            if (_windowRegistrations.ContainsKey(windowCode))
//                throw new InvalidOperationException($"Window with code '{windowCode}' is already registered.");
