...
public class StageBoundingBoxesOverlay : IHasSpriteSelectedEvent, ILingoMouseEventHandler, IDisposable
{
    ...
    public void RaiseMouseDown(LingoMouseEvent mouse) => OnMouseDown(mouse);
    ...
    public void RaiseMouseUp(LingoMouseEvent mouse) => OnMouseUp(mouse);
    ...
    public void RaiseMouseMove(LingoMouseEvent mouse) => OnMouseMove(mouse);
