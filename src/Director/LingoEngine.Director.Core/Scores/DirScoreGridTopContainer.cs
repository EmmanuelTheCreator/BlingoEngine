...
namespace LingoEngine.Director.Core.Scores
{
    public class DirScoreGridTopContainer : DirScoreGridContainer
    {
        ...
        public DirScoreGridTopContainer(IDirScoreManager scoreManager, ILingoColorPaletteDefinitions paletteDefinitions, Func<string, ILingoFrameworkGfxPanel, Windowing.IDirectorWindowDialogReference?> showConfirmDialog)
