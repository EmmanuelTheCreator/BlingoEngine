...
namespace LingoEngine.Director.Core.Scores
{
    public class DirScoreGridSprites2DContainer : DirScoreGridContainer
    {
        ...
        public DirScoreGridSprites2DContainer(IDirScoreManager scoreManager, Func<string, IAbstUIFrameworkGfxPanel, Windowing.IDirectorWindowDialogReference?> showConfirmDialog) : base(scoreManager, 10, showConfirmDialog)
        {
        }
        ...
        private void RecreateSpriteChannels()
        {
            ...
            {
                var spriteChannel = new DirScoreSprite2DChannel(i + LingoSprite2D.SpriteNumOffset + 1, _scoreManager);
