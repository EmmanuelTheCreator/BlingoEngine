        ...
        public static ILingoEngineRegistration WithDirectorEngine(this ILingoEngineRegistration engineRegistration, Action<DirectorProjectSettings>? directorSettingsConfig = null)
        {
            engineRegistration
                ...
                .ServicesMain(s => s
                    ...
                    .AddSingleton<IRNetConfiguration>(p => p.GetRequiredService<DirectorRemoteSettings>())
                    ...
                    .AddSingleton<IAbstCommandHandler<ConnectRNetServerCommand>>(p => p.GetRequiredService<DirectorRNetServer>())
                    .AddSingleton<IAbstCommandHandler<DisconnectRNetServerCommand>>(p => p.GetRequiredService<DirectorRNetServer>())
