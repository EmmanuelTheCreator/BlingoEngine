namespace BlingoEngine.Sprites
{
    ...
    /// </summary>
    public interface IBlingoPropertyDescriptionList
    {
        /// <summary>
    ...
    /// </summary>
        ...
        /// </summary>
        bool IsOKToAttach(BlingoSymbol spriteType, int spriteNum);
    }
    public interface IBlingoPropertyDescriptionListDialog
    {
