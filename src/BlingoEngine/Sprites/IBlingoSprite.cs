...
namespace BlingoEngine.Sprites
{
    ...
    /// </summary>
    public interface IBlingoSpriteBase : IHasPropertyChanged
    {
        /// <summary>
    ...
    /// Mirrors Lingo’s sprite object functionality.
    /// </summary>
    public interface IBlingoSprite : IBlingoSpriteBase
    {
        ...
        IBlingoSprite SetMember(int memberNumber, int? castLibNum = null);
        ...
        IBlingoSprite SetMember(string memberName, int? castLibNum = null);
        IBlingoSprite SetMember(IBlingoMember? member);

        IBlingoSprite AddBehavior<T>(Action<T>? configure = null) where T : BlingoSpriteBehavior;
        ...
        bool Intersects(IBlingoSprite other);
        bool Within(IBlingoSprite other);
