...
namespace BlingoEngine.Primitives
{
    ...
    /// </summary>
    public class BlingoList<T> : IList<T>
    {
        ...
        /// </summary>
        public BlingoList<T> Duplicate() => new BlingoList<T>(_items);

        /// <summary>
        /// Creates a new list from a collection.
        /// </summary>
        public BlingoList(IEnumerable<T> collection) => _items = new List<T>(collection);
