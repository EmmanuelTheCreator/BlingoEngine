namespace BlingoEngine.Primitives
{
    ...
    /// </summary>
    public class BlingoPropertyList<TValue> : BlingoPropertyList<BlingoSymbol,TValue>
    {
    ...
    /// A property list implementation that mimics Lingo's propList behavior, preserving insertion order.
    /// </summary>
    public class BlingoPropertyList<TKey, TValue> : IDictionary<TKey, TValue?> where TKey : notnull
    {
        ...
        {
            if (index < 1)
                throw new IndexOutOfRangeException("BlingoPropertyList is 1-based.");
        ...
        /// </summary>
        public BlingoPropertyList<TKey, TValue?> Duplicate()
        {
            var copy = new BlingoPropertyList<TKey, TValue?>();
        ...
        /// </summary>
        public void Merge(BlingoPropertyList<TKey, TValue?> other)
        {
        ...
        /// </summary>
        public BlingoSymbol Ilk() => BlingoSymbol.New(IlkName);
