...
public sealed class BlingoTransitionPlayer : IBlingoTransitionPlayer, IDisposable
{
    private readonly BlingoStage _stage;
    private readonly BlingoClock _clock;
    private readonly IBlingoTransitionLibrary _library;
    ...
    private BlingoBaseTransition? _transition;
    private int _tick;
    ...
    public BlingoTransitionPlayer(BlingoStage stage, BlingoClock clock, IBlingoTransitionLibrary library)
    {
        _stage = stage;
        _clock = clock;
        _library = library;
    ...
    public bool Start(BlingoTransitionSprite sprite)
    {
        ...
        var affects = sprite.Member?.Affects ?? BlingoTransitionAffects.EntireStage;
        _computeDiffRect = affects == BlingoTransitionAffects.ChangingAreaOnly;
        if (affects == BlingoTransitionAffects.Custom)
        {
