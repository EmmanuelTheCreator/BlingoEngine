...
public class BlingoTransitionLibrary : IBlingoTransitionLibrary
{
    private readonly Dictionary<int, BlingoBaseTransition> _transitions =
        new()
        {
    ...
    public BlingoBaseTransition Get(int id)
    {
    ...
    public IEnumerable<BlingoBaseTransition> GetAll() => _transitions.Values;
}
