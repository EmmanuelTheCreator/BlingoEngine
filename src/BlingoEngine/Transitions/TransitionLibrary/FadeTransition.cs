...
public sealed class FadeTransition : BlingoBaseTransition
{
    // Builtin fade effect used as the default transition (ID 0).
    public FadeTransition() : base(0, "Fade", "fade", "Linear fade between frames", BlingoTransitionCategory.Fade)
    {
    }
