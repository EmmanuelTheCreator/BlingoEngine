...
namespace BlingoEngine.Texts
{
    ...
    /// </summary>
    public class BlingoChars : IEnumerable<char> , IEnumerable
    {
        ...
        public static implicit operator string(BlingoChars blingoChar) => blingoChar.ToString();

        public override bool Equals(object? obj) => obj is BlingoChars lc && _word == lc._word;
        public override int GetHashCode() => _word.GetHashCode();
        public static bool operator ==(BlingoChars a, BlingoChars b) => a._word == b._word;
        public static bool operator !=(BlingoChars a, BlingoChars b) => !(a == b);
    }
