namespace BlingoEngine.Sounds
{
    ...
    /// </summary>
    public interface IBlingoSoundChannel
    {
        /// <summary>
        ...
        BlingoSoundChannelStatus Status { get; }
        int Volume { get; set; }
        /// <summary>
        ...
        /// </summary>
        BlingoPlayListSound[] GetPlayList();
        /// <summary>
        ...
        /// </summary>
        void SetPlayList(IEnumerable<BlingoPlayListSound> playList);
        void Pause();
        /// <summary>
        ...
        /// </summary>
        void Queue(BlingoMemberSound member, float startTime = -1, float endTime = -1, int loopCount = -1, float loopStartTime = -1, float loopEndTime = -1, float preloadTime = -1);
        void Rewind();
    ...
    public class BlingoSoundChannel : IBlingoSoundChannel
    {
        private Queue<BlingoPlayListSound> _playlist = new();
        private int _currentLoop;
        private bool mute;
        private readonly IBlingoFrameworkSoundChannel _frameworkSoundChannel;
        public T FrameworkObj<T>() where T : IBlingoFrameworkSoundChannel => (T)_frameworkSoundChannel;
        ...
        /// <inheritdoc/>
        public BlingoSoundChannelStatus Status { get; private set; }
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        public BlingoMemberSound? Member { get; private set; }
        /// <inheritdoc/>
        ...
        public BlingoSoundChannel(IBlingoFrameworkSoundChannel frameworkSoundChannel, int number)
        {
        ...
        {
            if (Status == BlingoSoundChannelStatus.Playing)
                Stop();
        ...
        private void ApplyPlaylistSound(BlingoPlayListSound song)
        {
        ...
        /// <inheritdoc/>
        public void Play(BlingoMemberSound? member = null, float startTime = -1, float endTime = -1, int loopCount = -1, float loopStartTime = -1, float loopEndTime = -1, float preloadTime = -1)
        {
        ...
        private void PlayNow(BlingoMemberSound member)
        {
            Status = BlingoSoundChannelStatus.Playing;
            _frameworkSoundChannel.PlayNow(member);
        }
        /// <inheritdoc/>
        public void Pause()
        {
            Status = BlingoSoundChannelStatus.Paused;
            _frameworkSoundChannel.Pause();
        }
        /// <inheritdoc/>
        public void Stop()
        {
            Status = BlingoSoundChannelStatus.Idle;
            _frameworkSoundChannel.Stop();
        }
        /// <inheritdoc/>
        public void Queue(BlingoMemberSound member, float startTime = -1, float endTime = -1, int loopCount = -1, float loopStartTime = -1, float loopEndTime = -1, float preloadTime = -1)
        {
            var sound = new BlingoPlayListSound(member);
        ...
        /// <inheritdoc/>
        public BlingoPlayListSound[] GetPlayList() => _playlist.ToArray();
        /// <inheritdoc/>
        public void SetPlayList(IEnumerable<BlingoPlayListSound> playList)
        {
            _playlist = new Queue<BlingoPlayListSound>(playList);
        }
        /// <inheritdoc/>
        public bool IsBusy() => Status == BlingoSoundChannelStatus.Playing;
