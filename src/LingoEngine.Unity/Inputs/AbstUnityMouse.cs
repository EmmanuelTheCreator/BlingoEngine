...
public class AbstUnityMouse<TLingoMouseType, TAbstUIMouseEvent> : IAbstUIFrameworkMouse
        where TLingoMouseType : AbstUIMouse<TAbstUIMouseEvent>
        where TAbstUIMouseEvent : AbstUIMouseEvent
{
    ...
    internal void SetLingoMouse(TLingoMouseType mouse) => _lingoMouse = new Lazy<TLingoMouseType>(() => mouse);
    ...
    public void ReplaceMouseObj(IAbstUIMouse lingoMouse) => _lingoMouse = new Lazy<TLingoMouseType>(() => (TLingoMouseType)lingoMouse);
