...
//    /// </summary>
//    public partial class LingoGodotWindow : BaseGodotWindow
//    {
//        public LingoGodotWindow(string name, IAbstWindow window, IServiceProvider serviceProvider) : base(name, window, serviceProvider)
//        {
//        }
...
//        //    LingoKey? key = null;
//        //    var impl = new LingoGodotKey(this, new Lazy<AbstKey>(() => key!));
