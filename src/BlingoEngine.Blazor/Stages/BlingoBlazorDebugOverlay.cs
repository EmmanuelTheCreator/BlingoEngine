...
/// </summary>
public class BlingoBlazorDebugOverlay : IBlingoFrameworkDebugOverlay
{
    ...
    public BlingoBlazorDebugOverlay(BlingoBlazorRootPanel root, IAbstComponentFactory factory)
    {
        _root = root;
        _factory = factory;
    }
