...
namespace BlingoEngine.Blazor.Shapes;
...
/// </summary>
public class BlingoBlazorMemberShape : IBlingoFrameworkMemberShape, IDisposable
{
    ...
    private int _stride;
    private BlingoMemberShape _member = null!;
    ...
    public BlingoBlazorMemberShape(IJSRuntime js, AbstUIScriptResolver scripts)
    {
        _js = js;
        _scripts = scripts;
    }

    internal void Init(BlingoMemberShape member) => _member = member;
    ...
    public IAbstTexture2D? RenderToTexture(BlingoInkType ink, AColor transparentColor) => _texture;
