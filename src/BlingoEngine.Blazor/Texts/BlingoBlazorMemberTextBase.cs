...
/// </summary>
public abstract class BlingoBlazorMemberTextBase<TText> : IBlingoFrameworkMemberTextBase, IDisposable where TText : IBlingoMemberTextBase
{
    ...
    public BlingoBlazorMemberTextBase(IJSRuntime js, AbstUIScriptResolver scripts, IAbstFontManager fontManager)
    {
        _js = js;
        _scripts = scripts;
    ...
    internal void Init(TText member) => _blingoMemberText = member;
