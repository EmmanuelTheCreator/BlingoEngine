...
public class SdlTexture2D : ILingoTexture2D 
{
    ...
    public ILingoTexture2D Clone(nint renderer)
    {
    ...
    public static nint CloneTexture(nint renderer, nint src)
    {
        ...
        SDL.SDL_RenderClear(renderer);
        var rect = new SDL.SDL_Rect { x = 0, y = 0, w = w, h = h };
        SDL.SDL_RenderCopy(renderer, src, IntPtr.Zero, ref rect);
    ...
    public static void DebugToDisk(nint renderer, nint texture, string folder, string fileName)
    {
        ...
        IntPtr surface = SDL.SDL_CreateRGBSurfaceWithFormat(0, w, h, 32, OUT_FMT);
