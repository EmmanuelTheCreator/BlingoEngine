...
public class LingoSDLComponentContext : IDisposable
{
    private readonly LingoSDLComponentContainer _container;
    private bool _requireRender = true;
    internal ILingoSDLComponent? Component { get; private set; }
    internal LingoSDLComponentContext? Parent { get; }
    ...
    internal LingoSDLComponentContext(LingoSDLComponentContainer container, ILingoSDLComponent? component = null, LingoSDLComponentContext? parent = null)
    {
    ...
    public void QueueRedraw(ILingoSDLComponent component)
    {
        _requireRender = true;
        Component ??= component;
    ...
    internal void RenderToTexture(LingoSDLRenderContext renderContext)
    {
        if (!Visible)
            return;
