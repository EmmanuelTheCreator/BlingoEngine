...
using LingoEngine.Net.Contracts;
using Microsoft.AspNetCore.SignalR.Client;

namespace LingoEngine.Net.Client;

/// <summary>
/// High-level API for interacting with a running Director host.
/// </summary>
public interface IDirectorClient : IAsyncDisposable
{
    /// <summary>Connects to the Director hub and sends the initial hello payload.</summary>
...
/// <summary>
/// Default implementation of <see cref="IDirectorClient"/>.
/// </summary>
public sealed class DirectorClient : IDirectorClient
{
