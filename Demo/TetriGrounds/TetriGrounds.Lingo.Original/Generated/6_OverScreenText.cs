...
public class OverScreenTextParent : LingoParentScript, IHasStepFrameEvent
{
    ...
    public OverScreenTextParent(ILingoMovieEnvironment env, GlobalVars global, object _Duration, object _text, object _myParent) : base(env)
    {
        ...
        GetMember<ILingoMemberTextBase>("T_OverScreen").Text = myText;
        GetMember<ILingoMemberTextBase>("T_OverScreen2").Text = myText;
        myParent = _myParent;
    }
