...
namespace LingoEngine.Demo.TetriGrounds.Core.MovieScripts
{
    ...
    public class StartMovieScript : LingoMovieScript, IHasStartMovieEvent, IHasStopMovieEvent
    {
        private readonly GlobalVars _global;

        public StartMovieScript(ILingoMovieEnvironment env, GlobalVars global) : base(env)
        {
            _global = global;
        }
