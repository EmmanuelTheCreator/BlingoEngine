...
namespace LingoEngine.Demo.TetriGrounds.Core.ParentScripts
{
    ...
    public class BlockScript : LingoParentScript, IHasStepFrameEvent
    {
        ...
        public BlockScript(ILingoMovieEnvironment env, GlobalVars global, int chosenType = 1) : base(env)
        {
            _global = global;
