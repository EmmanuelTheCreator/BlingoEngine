...
namespace LingoEngine.Demo.TetriGrounds.Core.ParentScripts
{
    ...
    public class BlocksScript : LingoParentScript, IHasStepFrameEvent
    {
        ...
        public BlocksScript(ILingoMovieEnvironment env, GlobalVars global, GfxScript gfx, ScoreManagerScript score, int width, int height) : base(env)
        {
            this.env = env;
            _global = global;
            myGfx = gfx;
