...
namespace LingoEngine.Demo.TetriGrounds.Core.ParentScripts
{
    ...
    public class StartDataSaveScript : LingoParentScript, IHasStepFrameEvent
    {
        ...
        public StartDataSaveScript(ILingoMovieEnvironment env, object? parent = null) : base(env)
        {
            myParent = parent;
        }
