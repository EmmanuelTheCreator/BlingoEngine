...
public class ExecuteBehavior : BlingoSpriteBehavior, IBlingoPropertyDescriptionList, IHasMouseLeaveEvent, IHasMouseDownEvent, IHasMouseEnterEvent, IHasBeginSpriteEvent
{
    ...
    public ExecuteBehavior(IBlingoMovieEnvironment env) : base(env) { }
