...
public class ScoreManagerParent : BlingoParentScript
{
    ...
    public BlingoList<object> myOverScreenText = new();

    private readonly GlobalVars _global;

    public ScoreManagerParent(IBlingoMovieEnvironment env, GlobalVars global) : base(env)
    {
        _global = global;
        ...
        // find stqrt level
        myLevel = Convert.ToInt32(GetMember<IBlingoMemberTextBase>("T_StartLevel").Text);
...
public void Refresh()
{
    ...
    UpdateGfxScore();
    GetMember<IBlingoMemberTextBase>("T_data").Text = "Level " + myLevel;
...
{
    GetMember<IBlingoMemberTextBase>("T_Score").Text = string(myPlayerScore);
}
