...
namespace LingoEngine.LGodot.Gfx
{
    ...
    public partial class LingoGodotLabel : Label, IAbstUIFrameworkGfxLabel, IDisposable
    {
        ...
        public LingoGodotLabel(AbstUIGfxLabel label, IAbstFontManager fontManager)
        {
        ...
        public AbstTextAlignment TextAlignment { get => HorizontalAlignment.ToLingo(); set => HorizontalAlignment = value.ToGodot(); }
