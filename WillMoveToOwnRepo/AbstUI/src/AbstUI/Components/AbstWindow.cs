...
namespace AbstUI.Components
{
    ...
    /// </summary>
    public class AbstWindow : AbstNodeLayoutBase<IAbstFrameworkWindow>, IAbstMouseRectProvider
    {
        ...
        public void Init(IAbstFrameworkWindow framework, IAbstMouse mouse, AbstKey key)
        {
            base.Init(framework);
            _mouse = mouse;
            _key = key;
        ...
        public AbstWindow AddItem(IAbstNode node)
        {
            _framework.AddItem(node.Framework<IAbstFrameworkLayoutNode>());
            return this;
        }

        public AbstWindow AddItem(IAbstFrameworkLayoutNode node)
        {
